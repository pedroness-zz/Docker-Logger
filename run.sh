...
chmod +x fswatch.sh
docker run -itd -v $(pwd)/app/json:/home/node/app/json ${DOCKERVOLUMECOMMAND} -p 706:706 -p 3000:3000 --name docker-logger-container beagenius/docker-logger http-server -d false --push-state --cors -p 706 
echo '['${JSONCONTENT:1}']'
