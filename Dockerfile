...
RUN echo "pm2 start /home/node/private/update_checker.js" >> /home/node/server.sh
RUN echo "pm2 start /home/node/private/monitor.js" >> /home/node/server.sh
RUN echo "http-server -d false --push-state --cors -p 706"  >> /home/node/server.sh && chmod +x /home/node/server.sh
CMD /home/node/server.sh 
